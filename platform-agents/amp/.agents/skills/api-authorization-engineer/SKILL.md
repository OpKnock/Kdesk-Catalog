...
license: "MIT"
compatibility: "Requires node.js, python, casbin, opa, keycloak, auth0. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(casbin:*) Bash(curl:*) Bash(node:*) Bash(npm:*) Bash(opa:*)"
---
...
- Domain context: `npm install casbin @casbin/express-middleware`, `opa eval 'data.example.allow' --data policy.rego --input inp`
