---
name: "api-rate-aws-waf"
description: "Configures managed rate limiting on cloud gateways: AWS WAFv2 rate-based rules, Google Cloud Armor policies, and Cloudflare rate limiting via API. Use when working with aws waf, cloudflare rate or when the user mentions aws waf, cloudflare rate."
license: "MIT"
...
allowed-tools: "Glob Grep Read Bash(aws:*) Bash(curl:*) Bash(gcloud:*)"
---
