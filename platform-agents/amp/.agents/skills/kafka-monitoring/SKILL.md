...
license: "MIT"
compatibility: "Requires java, kafka-broker-api-versions.sh, kafka-log-dirs.sh, kafka-run-class.sh, kafka-topics.sh."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(java:*) Bash(kafka-broker-api-versions.sh:*) Bash(kafka-log-dirs.sh:*) Bash(kafka-run-class.sh:*) Bash(kafka-topics.sh:*)"
---
