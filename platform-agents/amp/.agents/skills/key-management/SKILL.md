---
name: "key-management"
description: "Manage cryptographic keys across local openssl and cloud KMS (AWS KMS, GCP KMS, HashiCorp Vault): generation, encryption, and secure storage. Use when working with openssl keys, cloud kms, api or when the user mentions openssl keys, cloud kms, api."
license: "MIT"
compatibility: "Requires aws, gcloud, openssl, vault."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(aws:*) Bash(gcloud:*) Bash(openssl:*) Bash(vault:*)"
---
