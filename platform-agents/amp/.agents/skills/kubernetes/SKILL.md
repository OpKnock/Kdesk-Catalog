...
license: "MIT"
compatibility: "Requires k3s, kind, kubeadm, kubectl. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(k3s:*) Bash(kind:*) Bash(kubeadm:*) Bash(kubectl:*)"
---
