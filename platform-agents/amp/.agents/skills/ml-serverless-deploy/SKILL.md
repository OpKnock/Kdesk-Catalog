---
name: "ml-serverless-deploy"
description: "Serverless deployment agent handling ML serverless deployment. Use when working with Ml Serverless Deploy, deployment or when the user mentions Ml Serverless Deploy, deployment."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Deploy::*) Bash(Invoke::*) Bash(Status::*)"
---
