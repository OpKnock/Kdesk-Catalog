---
name: "nessus"
description: "Manages Tenable Nessus scans from the CLI: creating, launching, and reporting vulnerability scans. Use when working with nessus cli, code quality or when the user mentions nessus cli, code quality."
license: "MIT"
compatibility: "Requires nessuscli."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "code-quality"}
allowed-tools: "Glob Grep Read Bash(nessuscli:*)"
---
