---
name: "splunk"
description: "Drives log analysis and event ingestion in Splunk: runs bounded SPL queries, registers file monitor inputs, and pushes structured events through HTTP Event Collector and REST search endpoints. Use when working with splunk search ingest, api, log search or when the user mentions splunk search ingest, api, log search."
license: "MIT"
compatibility: "Requires splunk. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(./splunk:*) Bash(curl:*) Bash(splunk:*)"
---
