...
license: "MIT"
compatibility: "Requires docker, kafka-console-consumer, kafka-topics. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(docker:*) Bash(kafka-console-consumer:*) Bash(kafka-topics:*)"
---
