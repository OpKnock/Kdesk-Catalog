...
description: "Agent for managing Kubernetes clusters, deploying applications, and implementing GitOps workflows. Use when working with cluster management, kubernetes, k8s, gitops or when the user mentions cluster management, kubernetes, k8s, gitops."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(helm:*) Bash(k9s:*) Bash(kubectl:*) Bash(kustomize:*) Bash(stern:*)"
---
