...
description: "Delivers alerts to Slack via webhooks, email via mailx, SMS via Twilio, and push notifications via ntfy. Supports channel selection by severity and includes rate-limiting guidance. Use when working with notification delivery, api or when the user mentions notification delivery, api."
license: "MIT"
compatibility: "Requires echo, ntfy. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(echo:*) Bash(ntfy:*)"
---
