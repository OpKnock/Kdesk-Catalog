---
name: "onprem-config-onprem-deploy-py"
description: "On-premises deployment agent. Manages on-premises ML deployment. Use when working with Ml Onprem Deploy Agent or when the user mentions Ml Onprem Deploy Agent."
...
- Domain context: `python config_onprem_deploy.py --model-path /models/model.pt`
