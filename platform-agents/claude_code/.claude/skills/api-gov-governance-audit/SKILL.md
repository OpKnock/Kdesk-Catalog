---
name: "api-gov-governance-audit"
description: "Audits and enforces API governance on existing OpenAPI specs, blocking non-compliant changes via CI linting with Spectral rulesets. Use when working with governance audit, compliance gates or when the user mentions governance audit, compliance gates."
license: "MIT"
compatibility: "Requires spectral, openapi, node.js, python, stoplight-studio."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(git:*) Bash(npx:*) Bash(openapi-diff:*) Bash(redocly:*) Bash(swagger-cli:*)"
---
