...
license: "MIT"
compatibility: "Requires prism, wiremock, msw, openapi, node.js, python. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "testing"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(docker:*) Bash(mb:*) Bash(npm:*)"
---
