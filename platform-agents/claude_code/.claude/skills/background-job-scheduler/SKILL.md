...
license: "MIT"
compatibility: "Requires redis, node.js, python, rabbitmq, bull-board, flower."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(celery:*) Bash(crontab:*) Bash(python:*) Bash(redis-cli:*) Bash(rq:*) Bash(systemctl:*)"
---
