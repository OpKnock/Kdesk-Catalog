...
description: "Creates data visualizations: matplotlib/seaborn charts, interactive notebooks, and export. Use when working with plotting or when the user mentions plotting."
license: "MIT"
compatibility: "Requires d3, plotly, recharts, chart.js, echarts."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "data"}
allowed-tools: "Glob Grep Read Bash(jupyter:*) Bash(python:*)"
---
