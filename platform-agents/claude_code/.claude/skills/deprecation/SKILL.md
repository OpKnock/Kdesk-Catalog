---
name: "deprecation"
description: "Manages endpoint phase-out lifecycle: Sunset headers, spec linting for metadata, and usage auditing before removal. Use when working with deprecation audit, api or when the user mentions deprecation audit, api."
license: "MIT"
compatibility: "Requires grep, npx, spectral. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Read Bash(curl:*) Grep Bash(npx:*) Bash(spectral:*)"
---
...
- Domain context: `spectral lint openapi.yaml -r .spectral/deprecation.rules.ym`
