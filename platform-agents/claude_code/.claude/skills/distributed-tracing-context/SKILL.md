...
license: "MIT"
compatibility: "Requires docker, jaeger, otelcol-contrib. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(docker:*) Bash(jaeger:*) Bash(otelcol-contrib:*)"
---
