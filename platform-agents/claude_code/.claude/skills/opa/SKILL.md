---
name: "opa"
description: "Evaluate Rego queries against data and inputs. Run Rego unit tests, format code, and build bundles. Serve policies over HTTP handling live decisions. workflows.'. Use when working with policy evaluation, testing and linting, server mode, security or when the user mentions policy evaluation, testing and linting, server mode, security."
license: "MIT"
compatibility: "Requires opa. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(opa:*)"
---
