...
license: "MIT"
compatibility: "Requires pyspark, spark-shell, spark-sql, spark-submit."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "data"}
allowed-tools: "Glob Grep Read Bash(pyspark:*) Bash(spark-shell:*) Bash(spark-sql:*) Bash(spark-submit:*)"
---
