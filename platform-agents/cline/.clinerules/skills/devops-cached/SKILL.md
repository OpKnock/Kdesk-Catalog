...
allowed-tools: "Glob Grep Read Bash(Format::*) Bash(Invalidation::*) Bash(Quality::*) Bash(Resize::*)"
---
...
- Domain context: `Format: curl http://localhost:8080/image.jpg?format=webp`
