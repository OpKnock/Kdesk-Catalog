...
description: "Homebrew agent for package management on macOS/Linux. Use when working with Devops Homebrew, deployment or when the user mentions Devops Homebrew, deployment."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(Doctor::*) Bash(Install::*) Bash(Update::*) Bash(Upgrade::*)"
---
