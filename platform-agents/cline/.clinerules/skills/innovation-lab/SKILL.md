...
license: "MIT"
compatibility: "Requires figma, notion, slack, github, miro."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "strategy"}
allowed-tools: "Glob Grep Read Bash(docker:*) Bash(git:*) Bash(jupyter:*) Bash(npm:*) Bash(pip:*) Bash(python:*)"
---
...
- Domain context: `npm create vite@latest idea -- --template react-ts`, `jupyter lab --port 8888 --no-browser`
