...
description: "Designs and implements error handling: RFC 9457 formats, error catalogs, middleware, and OpenAPI documentation for REST and GraphQL. Use when working with error format impl, graphql errors or when the user mentions error format impl, graphql errors."
license: "MIT"
compatibility: "Requires node.js, python, openapi, postman, swagger-ui. Needs network access."
