...
license: "MIT"
compatibility: "Requires kong, traefik, aws-cli, docker, kubernetes, nginx. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(docker:*) Bash(helm:*) Bash(kubectl:*) Bash(nginx:*) Bash(node:*)"
---
