---
name: "api-middleware-fastify-plugins"
description: "Builds Fastify APIs with the official plugin ecosystem: @fastify/cors, @fastify/rate-limit, @fastify/jwt, @fastify/helmet, and @fastify/sensible for unified error responses. Use when working with fastify plugins, plugin encapsulation or when the user mentions fastify plugins, plugin encapsulation."
license: "MIT"
compatibility: "Requires node.js, python, express, fastify, koa. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(fastify:*) Bash(node:*) Bash(npm:*)"
---
...
- Domain context: `npm install fastify @fastify/cors @fastify/rate-limit @fasti`, `fastify start -p 3000 app.js`
