...
license: "MIT"
compatibility: "Requires aws-shield, cloudflare, nginx, varnish, akamai. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(ab:*) Bash(curl:*) Bash(iptables:*) Bash(nginx:*) Bash(tcpdump:*)"
---
