...
license: "MIT"
compatibility: "Requires kubernetes, docker, curl, node.js, python, grpc-health-probe. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(nc:*) Bash(openssl:*) Bash(tcping:*) Bash(timeout:*)"
---
