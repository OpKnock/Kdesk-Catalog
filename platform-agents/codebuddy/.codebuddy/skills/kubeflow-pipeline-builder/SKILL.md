...
description: "Agent for building and deploying Kubeflow ML pipelines with component creation and pipeline monitoring. Use when working with pipeline building, kubeflow, pipelines or when the user mentions pipeline building, kubeflow, pipelines."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(dsl:*) Bash(kfp:*) Bash(python:*)"
---
