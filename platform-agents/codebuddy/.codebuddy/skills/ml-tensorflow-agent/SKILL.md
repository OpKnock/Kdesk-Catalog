...
description: "TensorFlow agent for deep learning development. Use when working with Ml Tensorflow Agent, training or when the user mentions Ml Tensorflow Agent, training."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(SavedModel::*) Bash(TFLite::*) Bash(TensorBoard::*) Bash(Train::*)"
---
...
- Domain context: `Train: python -c 'import tensorflow as tf; model = tf.keras.`
