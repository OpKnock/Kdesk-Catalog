...
description: "Project server agent. Manages Project ML server. Use when working with Ml Project Server Agent or when the user mentions Ml Project Server Agent."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(project:*) Bash(python:*) Bash(supervisorctl:*) Bash(systemctl:*)"
---
