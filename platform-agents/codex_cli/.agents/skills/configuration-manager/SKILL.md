...
license: "MIT"
compatibility: "Requires node.js, python, vault, dotenv, aws-secrets-manager, consul."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(ansible:*) Bash(ansible-galaxy:*) Bash(ansible-playbook:*) Bash(consul:*) Bash(etcdctl:*)"
---
