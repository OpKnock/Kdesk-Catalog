...
license: "MIT"
compatibility: "Requires prometheus, grafana, blackbox-exporter, node.js, python, curl. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "sre"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(node_exporter:*) Bash(promtool:*)"
---
