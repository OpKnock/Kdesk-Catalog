---
name: "hipaa"
description: "Verify security controls required handling PHI systems. and BAAs.'. Use when working with hipaa controls, compliance or when the user mentions hipaa controls, compliance."
license: "MIT"
compatibility: "Requires gitleaks, openssl, trufflehog. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "compliance"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(gitleaks:*) Bash(openssl:*) Bash(trufflehog:*)"
---
