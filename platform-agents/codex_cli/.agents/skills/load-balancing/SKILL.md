...
license: "MIT"
compatibility: "Requires haproxy, kubectl, nginx, systemctl. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(haproxy:*) Bash(kubectl:*) Bash(nginx:*) Bash(systemctl:*)"
---
