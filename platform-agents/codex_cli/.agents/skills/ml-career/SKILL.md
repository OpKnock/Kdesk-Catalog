...
allowed-tools: "Glob Grep Read Bash(GitHub::*) Bash(Interview::*) Bash(LinkedIn::*) Bash(Resume::*)"
---
...
- Domain context: `Resume: python resume-builder; resume.create('my-resume.pdf'`
