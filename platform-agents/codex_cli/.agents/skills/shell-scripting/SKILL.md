...
license: "MIT"
compatibility: "Requires bash, checkbashisms, command, local, readonly, set. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devtools"}
allowed-tools: "Glob Grep Read Bash(bash:*) Bash(checkbashisms:*) Bash(command:*) Bash(local:*) Bash(readonly:*) Bash(set:*) Bash(shellcheck:*)"
---
