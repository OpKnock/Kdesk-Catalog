---
name: "cache-invalidation-engineer"
description: "Agent for implementing cache invalidation strategies with event-driven updates and consistency guarantees. Use when working with cache invalidation, cache invalidation, consistency, event driven or when the user mentions cache invalidation, cache invalidation, consistency, event driven."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "database"}
allowed-tools: "Glob Grep Read Bash(kafka:*) Bash(rabbitmq:*) Bash(redis-cli:*)"
---
