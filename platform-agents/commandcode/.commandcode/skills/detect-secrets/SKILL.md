...
license: "MIT"
compatibility: "Requires detect-secrets, detect-secrets-hook, git, pre-commit."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(detect-secrets:*) Bash(detect-secrets-hook:*) Bash(git:*) Bash(pre-commit:*)"
---
