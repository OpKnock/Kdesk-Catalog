---
name: "health-check"
description: "Endpoint health checking from the CLI: curl -f probes, TCP checks with nc, HTTP status verification, and Kubernetes readiness waits. Use when working with endpoint probing, api or when the user mentions endpoint probing, api."
license: "MIT"
compatibility: "Requires kubectl, wget. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(kubectl:*) Bash(nc:*) Bash(wget:*)"
---
