...
license: "MIT"
compatibility: "Requires kafka-console-consumer.sh, kafka-consumer-groups.sh."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(go:*) Bash(kafka-console-consumer.sh:*) Bash(kafka-consumer-groups.sh:*)"
---
