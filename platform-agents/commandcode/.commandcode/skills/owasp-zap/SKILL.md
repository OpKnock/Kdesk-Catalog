...
license: "MIT"
compatibility: "Requires zap-api-scan.py, zap-cli, zap-full-scan.py, zap.sh."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "code-quality"}
allowed-tools: "Glob Grep Read Bash(zap-api-scan.py:*) Bash(zap-cli:*) Bash(zap-full-scan.py:*) Bash(zap.sh:*)"
---
...
- Domain context: `zap.sh -daemon -port 8080 -config api.key=changeme`
