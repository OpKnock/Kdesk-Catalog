---
name: "devops-kubent"
description: "Kubent agent for Kubernetes deprecated resource detection. Use when working with Devops Kubent, deployment or when the user mentions Devops Kubent, deployment."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(Cluster::*) Bash(Files::*) Bash(Helm::*) Bash(Output::*)"
---
