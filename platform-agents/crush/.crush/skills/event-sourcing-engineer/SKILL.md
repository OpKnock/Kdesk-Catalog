...
license: "MIT"
compatibility: "Requires eventstore, kafka, node.js, python, postgresql, redis. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(confluent:*) Bash(curl:*) Bash(docker:*) Bash(kafka-consumer-groups.sh:*) Bash(kafka-streams-application-reset.sh:*) Bash(ksql:*)"
---
