...
description: "Elasticsearch monitoring agent for cluster health and performance. Use when working with Monitoring Elastic or when the user mentions Monitoring Elastic."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "monitoring"}
allowed-tools: "Glob Grep Read Bash(Health::*) Bash(Indices::*) Bash(Shards::*) Bash(Stats::*)"
---
