---
name: "nginx-tuning"
description: "Optimizes nginx for production with worker process sizing, keepalive tuning, kernel parameter adjustments, gzip compression, and load testing validation with ab. Use when working with nginx performance tuning, api or when the user mentions nginx performance tuning, api."
license: "MIT"
compatibility: "Requires nginx, sysctl."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(ab:*) Bash(nginx:*) Bash(sysctl:*)"
---
