...
license: "MIT"
compatibility: "Requires kube-linter (install via `go install golang.stackrox.io/kube-linter/cmd/kube-linter@latest`), go, kube-linter."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "code-quality"}
allowed-tools: "Glob Grep Read Bash(kube-linter:*)"
---
