...
license: "MIT"
compatibility: "Requires apache-atlas, amundsen, great-expectations, node.js, python, metacat."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "data"}
allowed-tools: "Glob Grep Read Bash(datahub:*) Bash(great_expectations:*) Bash(soda:*)"
---
...
- Domain context: `datahub ingest -c recipes/mysql.yml`
