...
license: "MIT"
compatibility: "Requires kafka, rabbitmq, kcat, kafka-ui, rabbitmqctl, nats-cli."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(rabbitmq-plugins:*) Bash(rabbitmqctl:*) Bash(redis-cli:*)"
---
