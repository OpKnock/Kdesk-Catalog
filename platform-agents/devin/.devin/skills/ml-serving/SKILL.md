...
allowed-tools: "Glob Grep Read Bash(BentoML::*) Bash(TorchServe::*) Bash(Triton::*) Bash(vLLM::*)"
---
...
- Domain context: `vLLM: python -m vllm.entrypoints.openai.api_server --model m`
