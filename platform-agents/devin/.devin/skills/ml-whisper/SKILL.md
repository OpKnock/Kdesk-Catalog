---
name: "ml-whisper"
description: "Whisper agent for speech recognition and transcription. Use when working with Ml Whisper, inference or when the user mentions Ml Whisper, inference."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(API::*) Bash(Batch::*) Bash(CLI::*) Bash(Python::*)"
---
