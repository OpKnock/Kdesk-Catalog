---
name: "mocking"
description: "General-purpose API mocking: mountebank imposters, response templating, request matching, and delay/fault simulation. Use when working with api mocking or when the user mentions api mocking."
license: "MIT"
compatibility: "Requires mb. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(mb:*)"
---
