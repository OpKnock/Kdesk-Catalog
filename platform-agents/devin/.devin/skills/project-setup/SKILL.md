...
license: "MIT"
compatibility: "Requires cargo, cookiecutter, echo, git, npx, python."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devtools"}
allowed-tools: "Glob Grep Read Bash(cargo:*) Bash(cookiecutter:*) Bash(echo:*) Bash(gh:*) Bash(git:*) Bash(go:*) Bash(npx:*)"
---
