---
name: "retry"
description: "Expert reference covering GNU timeout, curl retry flags, wait-for-service loops, and systemd/supervisor restart policies suited to long-running jobs. Use when working with shell job retry, api or when the user mentions shell job retry, api."
license: "MIT"
compatibility: "Requires systemctl, timeout, until. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(gh:*) Bash(systemctl:*) Bash(timeout:*) Bash(until:*)"
---
