...
license: "MIT"
compatibility: "Requires nginx. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(nginx:*)"
---
...
- Domain context: `curl -s -X POST http://localhost:8001/services -d 'name=orde`
