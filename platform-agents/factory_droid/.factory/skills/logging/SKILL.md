---
name: "logging"
description: "System and application logging basics: tail/grep log files, journald queries, syslog emission, and kernel message checks. Use when working with file logs, journald syslog, api or when the user mentions file logs, journald syslog, api."
license: "MIT"
compatibility: "Requires dmesg, grep, journalctl, logger, tail."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Read Bash(dmesg:*) Grep Bash(journalctl:*) Bash(logger:*) Bash(tail:*)"
---
