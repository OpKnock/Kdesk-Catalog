...
description: "Designs and runs API tests with Postman collections via Newman CLI, including environments, data files, and reporters. Use when working with newman runs, data driven, reporters, testing or when the user mentions newman runs, data driven, reporters, testing."
license: "MIT"
compatibility: "Requires newman."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "testing"}
allowed-tools: "Glob Grep Read Bash(newman:*)"
---
