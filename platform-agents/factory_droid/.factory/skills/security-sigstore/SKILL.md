...
allowed-tools: "Glob Grep Read Bash(Attestation::*) Bash(Policy::*) Bash(Rekor::*) Bash(Verify::*)"
---
...
- Domain context: `Attestation: cosign verify-attestation --type spdx image:tag`
