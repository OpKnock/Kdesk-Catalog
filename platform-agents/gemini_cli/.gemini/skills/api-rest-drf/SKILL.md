...
license: "MIT"
compatibility: "Requires node.js, python, express, fastapi, fastify, openapi. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(django-admin:*) Bash(pip:*) Bash(python:*)"
---
