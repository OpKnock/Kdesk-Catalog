...
description: "Agent for implementing deep linking with universal links, app links, and deferred deep links. Use when working with deep linking, deep links, universal links, app links or when the user mentions deep linking, deep links, universal links, app links."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "mobile"}
allowed-tools: "Glob Grep Read Bash(adjust:*) Bash(branch:*) Bash(firebase-dynamic-links:*)"
---
