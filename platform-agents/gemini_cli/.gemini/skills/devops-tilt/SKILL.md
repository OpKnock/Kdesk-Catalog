---
name: "devops-tilt"
description: "Tilt agent for Kubernetes inner loop development. Use when working with Devops Tilt, deployment or when the user mentions Devops Tilt, deployment."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(Args::*) Bash(Dashboard::*) Bash(Down::*) Bash(Up::*)"
---
