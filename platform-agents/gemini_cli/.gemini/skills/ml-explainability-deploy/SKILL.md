---
name: "ml-explainability-deploy"
description: "Explainability deployment agent for ML explainability service deployment. Use when working with Ml Explainability Deploy or when the user mentions Ml Explainability Deploy."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(API::*) Bash(Health::*) Bash(Server::*)"
---
...
- Domain context: `Server: python -m explainability.server --port 8080`
