---
name: "monitoring-sre"
description: "Builds monitoring stacks with Prometheus, Grafana, and exporters, querying metrics and alerting on SLO burn. Use when working with prometheus operations, grafana management, exporter setup, sre or when the user mentions prometheus operations, grafana management, exporter setup, sre."
license: "MIT"
compatibility: "Requires blackbox_exporter, grafana-cli, kube-state-metrics, node_exporter, promtool. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "sre"}
allowed-tools: "Glob Grep Read Bash(blackbox_exporter:*) Bash(curl:*) Bash(grafana-cli:*) Bash(kube-state-metrics:*) Bash(node_exporter:*) Bash(promtool:*)"
---
