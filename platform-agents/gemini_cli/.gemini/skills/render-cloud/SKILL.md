---
name: "render-cloud"
description: "Deploys web services, static sites, and background workers to Render with the CLI and render.yaml infrastructure configs. Use when working with render cli, render infra, cloud or when the user mentions render cli, render infra, cloud."
license: "MIT"
compatibility: "Requires npm, render."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "cloud"}
allowed-tools: "Glob Grep Read Bash(npm:*) Bash(render:*)"
---
