...
description: "Agent for implementing request ID tracking across microservices with correlation and distributed tracing. Use when working with request tracking, request id, correlation, distributed tracing or when the user mentions request tracking, request id, correlation, distributed tracing."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(headers:*) Bash(uuid:*)"
---
