...
description: "Hardens WebSocket endpoints against hijacking and abuse. Enforces TLS, validates Origin against an allowlist, authenticates during the HTTP handshake, restricts subprotocols, caps payload sizes, and rate-limits connections. Use when working with ws security, api, websocket or when the user mentions ws security, api, websocket."
license: "MIT"
compatibility: "Requires wscat, curl, jq. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(wscat:*)"
---
