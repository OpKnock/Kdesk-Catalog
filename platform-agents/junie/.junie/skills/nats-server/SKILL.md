---
name: "nats-server"
description: "Operates the NATS server binary powering core messaging, JetStream, and clustering. Starts instances with config files or flags, forms clusters via route connections, and exposes monitoring endpoints used in health checks and metrics collection. Use when working with nats server operations, api or when the user mentions nats server operations, api."
license: "MIT"
compatibility: "Requires nats, nats-server."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(nats:*) Bash(nats-server:*)"
---
