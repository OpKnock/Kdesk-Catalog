---
name: "nvm"
description: "Installs and switches Node.js versions with nvm: version management, aliases, .nvmrc files, and per-project Node selection. Use when working with version management, aliases and autoload, devtools or when the user mentions version management, aliases and autoload, devtools."
license: "MIT"
compatibility: "Requires nvm."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devtools"}
allowed-tools: "Glob Grep Read Bash(nvm:*)"
---
