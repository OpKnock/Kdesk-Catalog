...
license: "MIT"
compatibility: "Requires aws, kubectl, sops, vault. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(aws:*) Bash(kubectl:*) Bash(sops:*) Bash(vault:*)"
---
...
- Domain context: `kubectl create secret generic api --from-file=config.json --`
