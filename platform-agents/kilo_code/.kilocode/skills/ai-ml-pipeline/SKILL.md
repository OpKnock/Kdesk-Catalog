...
license: "MIT"
compatibility: "Requires python, scikit-learn, tensorflow, mlflow, kubeflow. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "data"}
allowed-tools: "Glob Grep Read Bash(dvc:*) Bash(kfp:*) Bash(kubectl:*) Bash(mlflow:*)"
---
