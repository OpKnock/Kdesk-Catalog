...
description: "Implements gateway architecture patterns: BFF composition, protocol translation, routing, and centralized security across clients. Use when working with bff composition, protocol translation or when the user mentions bff composition, protocol translation."
license: "MIT"
compatibility: "Requires kong, aws-api-gateway, nginx, node.js, express. Needs network access."
