...
description: "Advanced GraphQL implementation: codegen-typed resolvers, DataLoader batching, query-cost protection, and persisted operations. Use when working with typed codegen, persisted queries or when the user mentions typed codegen, persisted queries."
license: "MIT"
compatibility: "Requires apollo-server, graphql-codegen, dataloader, node.js, python. Needs network access."
