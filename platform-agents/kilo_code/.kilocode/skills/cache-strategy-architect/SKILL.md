...
license: "MIT"
compatibility: "Requires redis, memcached, varnish, cdn, node.js, python. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(nginx:*) Bash(redis-cli:*)"
---
