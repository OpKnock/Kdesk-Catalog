...
description: "Implements client and server-side form validation with Zod, React Hook Form, and HTML constraint validation, with linting gates in CI. Use when working with zod schemas, html validation or when the user mentions zod schemas, html validation."
license: "MIT"
compatibility: "Requires react, react-hook-form, zod, yup, ajv, node.js."
