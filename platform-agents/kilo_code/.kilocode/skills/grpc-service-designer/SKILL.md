...
description: "Designs gRPC services with protobuf and buf: linting conventions, breaking-change checks, and live server probing with grpcurl. Use when working with buf, grpcurl or when the user mentions buf, grpcurl."
license: "MIT"
compatibility: "Requires protoc, grpcurl, grpc-health-probe, buf, postman, bloomrpc. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(buf:*) Bash(grpcurl:*)"
---
