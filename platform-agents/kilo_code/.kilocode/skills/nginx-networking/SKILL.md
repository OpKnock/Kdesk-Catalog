...
license: "MIT"
compatibility: "Requires nginx, tail. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "networking"}
allowed-tools: "Glob Grep Read Bash(ab:*) Bash(curl:*) Bash(nginx:*) Bash(tail:*)"
---
