...
description: "SRE monitoring agent. Manages monitoring setup, alerting, and observability. Use when working with Sre Monitoring Agent or when the user mentions Sre Monitoring Agent."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "sre"}
allowed-tools: "Glob Grep Read Bash(alertmanager:*) Bash(curl:*) Bash(grafana-server:*) Bash(prometheus:*)"
---
