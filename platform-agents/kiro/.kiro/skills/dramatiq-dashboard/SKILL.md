...
license: "MIT"
compatibility: "Requires gunicorn, pip, python, redis-cli, uvicorn. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(gunicorn:*) Bash(pip:*) Bash(python:*) Bash(redis-cli:*) Bash(uvicorn:*)"
---
