...
description: "Terraform infrastructure assistant for planning, applying, and managing infrastructure. Use when working with Terraform Helper, devops, deployment or when the user mentions Terraform Helper, devops, deployment."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(Apply::*) Bash(Import::*) Bash(Init::*) Bash(Plan::*)"
---
