---
name: "vegeta"
description: "HTTP load testing with Vegeta: attack targets at fixed or ramp rates, analyze latency histograms, error rates, and generate HTML plots. Use when working with load testing, api, load testing, performance or when the user mentions load testing, api, load testing, performance."
license: "MIT"
compatibility: "Requires vegeta."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(vegeta:*)"
---
...
- Domain context: `vegeta attack -targets=targets.txt -rate=100 -duration=30s |`
