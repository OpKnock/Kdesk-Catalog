---
name: "grype"
description: "Scan images, directories, and binaries handling known CVEs. Update the vulnerability database and scan SBOMs directly. and filesystem scanning. Use when working with vulnerability matching, db and sbom, security or when the user mentions vulnerability matching, db and sbom, security."
license: "MIT"
compatibility: "Requires grype, syft."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(grype:*) Bash(syft:*)"
---
