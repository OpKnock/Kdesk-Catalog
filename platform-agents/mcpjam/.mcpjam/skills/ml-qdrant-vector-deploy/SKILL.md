---
name: "ml-qdrant-vector-deploy"
description: "Qdrant Vector deployment agent handling ML Qdrant vector deployment. Use when working with Ml Qdrant Vector Deploy, vector db or when the user mentions Ml Qdrant Vector Deploy, vector db."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Create::*) Bash(Search::*) Bash(Upsert::*)"
---
