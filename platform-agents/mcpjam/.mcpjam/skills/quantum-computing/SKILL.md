...
description: "Builds and runs quantum circuits with Qiskit: circuit design, simulation, and IBM Quantum runtime execution. Use when working with qiskit, ibm runtime or when the user mentions qiskit, ibm runtime."
license: "MIT"
compatibility: "Requires python, qiskit, cirq, pennylane, ibm-quantum."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "emerging"}
...
- Domain context: `pip install qiskit qiskit-ibm-runtime qiskit-aer`, `python -c "from qiskit_ibm_runtime import QiskitRuntimeServi`
