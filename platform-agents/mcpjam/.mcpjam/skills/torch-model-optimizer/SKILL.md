...
allowed-tools: "Glob Grep Read Bash(torch.jit.optimize_for_inference:*) Bash(torch.onnx.export:*) Bash(torch.quantization.quantize_dynamic:*) Bash(torch.utils.mobile_optimizer.optimize_for_mobile:*)"
---
