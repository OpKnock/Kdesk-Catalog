...
license: "MIT"
compatibility: "Requires apollo-server, graphql-codegen, node.js, python, strawberry, ariadne. Needs network access."
...
- Domain context: `npm install dataloader`, `npm install express-jwt`
