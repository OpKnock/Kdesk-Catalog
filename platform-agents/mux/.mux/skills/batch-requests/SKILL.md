---
name: "batch-requests"
description: "Combines multiple API calls into single HTTP round trips using JSON-RPC batch arrays, GraphQL operation aliases, and dedicated batch endpoints to reduce client-side latency over high-latency networks. Use when working with jsonrpc batch, graphql batching, server batch, api or when the user mentions jsonrpc batch, graphql batching, server batch, api."
license: "MIT"
compatibility: "Requires jq. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(jq:*)"
---
