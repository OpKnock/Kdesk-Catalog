...
license: "MIT"
compatibility: "Requires cloudflare-cli, aws-cli, fastly-cli, terraform, curl, webpagetest. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(ab:*) Bash(curl:*) Bash(openssl:*)"
---
