...
description: "Improves DX: unified dev commands, parallel task runners, instant feedback loops, and consistent tooling. Use when working with dx tooling or when the user mentions dx tooling."
license: "MIT"
compatibility: "Requires node.js, storybook, docusaurus, github-actions, figma."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "platform"}
allowed-tools: "Glob Grep Read Bash(npm:*) Bash(npm-run-all:*) Bash(npx:*)"
---
