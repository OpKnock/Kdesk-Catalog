...
license: "MIT"
compatibility: "Requires kafka-console-consumer.sh, kafka-consumer-groups.sh, kafka-topics.sh, pip, python."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(kafka-console-consumer.sh:*) Bash(kafka-consumer-groups.sh:*) Bash(kafka-topics.sh:*) Bash(pip:*) Bash(python:*)"
---
