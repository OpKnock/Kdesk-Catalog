...
license: "MIT"
compatibility: "Requires npm, npx, ollama, openai, pip, python. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(npm:*) Bash(npx:*) Bash(ollama:*) Bash(openai:*) Bash(pip:*) Bash(python:*)"
---
