---
name: "security-trivy"
description: "Trivy agent for comprehensive security scanning. Use when working with Security Trivy, scanning or when the user mentions Security Trivy, scanning."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(Filesystem::*) Bash(Image::*) Bash(Repo::*) Bash(SBOM::*)"
---
