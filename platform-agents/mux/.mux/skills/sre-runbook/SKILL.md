---
name: "sre-runbook"
description: "it agent handling incident procedures, recovery steps. Use when working with Sre Runbook or when the user mentions Sre Runbook."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "sre"}
allowed-tools: "Glob Grep Read Bash(Escalation::*) Bash(Incident::*) Bash(Post-mortem::*) Bash(Recovery::*)"
---
