---
name: "ml-ollama"
description: "Ollama agent for running large language models locally. Use when working with Ml Ollama, inference or when the user mentions Ml Ollama, inference."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Create::*) Bash(List::*) Bash(Pull::*) Bash(Run::*)"
---
