...
license: "MIT"
compatibility: "Requires prometheus, grafana, opentelemetry-collector, jaeger, loki, tempo. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(docker:*) Bash(otel-cli:*) Bash(otelcol:*) Bash(otelcol-contrib:*) Bash(tracegen:*)"
---
