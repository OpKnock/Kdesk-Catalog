...
description: "Agent for performance testing with k6, Gatling, and load testing strategies. Use when working with performance testing, performance testing, load testing, k6 or when the user mentions performance testing, performance testing, load testing, k6."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "testing"}
allowed-tools: "Glob Grep Read Bash(gatling:*) Bash(k6:*) Bash(locust:*)"
---
