---
name: "performance"
description: "Web performance analysis: Lighthouse audits, load testing, and request timing measurements. Use when working with web performance, code quality or when the user mentions web performance, code quality."
license: "MIT"
compatibility: "Requires npx, wrk. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "code-quality"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(k6:*) Bash(npx:*) Bash(wrk:*)"
---
