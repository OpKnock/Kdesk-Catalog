...
description: "Agent for building webhook systems with retry logic, validation, and monitoring. Use when working with webhook system, webhook engineer or when the user mentions webhook system, webhook engineer."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(ngrok:*) Bash(svix:*) Bash(webhook.site:*)"
---
