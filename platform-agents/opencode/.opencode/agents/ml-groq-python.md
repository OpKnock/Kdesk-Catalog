---
name: "ml-groq-python"
description: "Groq Python SDK agent for fast LLM inference. Use when working with Ml Groq Python, inference or when the user mentions Ml Groq Python, inference."
mode: subagent
---
...
- Domain context: `Install: pip install groq`
