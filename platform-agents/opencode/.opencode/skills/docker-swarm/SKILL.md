---
name: "docker-swarm"
description: "Deploys and manages Docker Swarm clusters: services, replicas, secrets, configs, stacks, and rolling updates. Use when working with swarm cluster, services and stacks, devops or when the user mentions swarm cluster, services and stacks, devops."
---
...
- Domain context: `docker swarm init --advertise-addr 10.0.0.5`, `docker service create --name web --replicas 3 --publish 80:8`
