...
description: "Agent for optimizing AWS Lambda functions with cold start reduction, memory tuning, and cost optimization. Use when working with lambda optimization, aws or when the user mentions lambda optimization, aws."
type: knowledge
triggers: ["aws-lambda-optimizer", "lambda-optimization"]
---
