---
name: "collaboration-inference"
description: "Collaboration inference server agent Manages Collaboration inference server. Use when working with Ml Collaboration Inference Server Agent V2 or when the user mentions Ml Collaboration Inference Server Agent V2."
type: knowledge
triggers: ["collaboration-inference", "ml collaboration inference server agent v2"]
---
