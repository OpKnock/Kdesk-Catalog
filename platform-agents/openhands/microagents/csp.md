---
name: "csp"
description: "Hardens API and web endpoints with Content-Security-Policy headers, using Helmet middleware and curl verification against real echo services. Use when working with header verification, helmet config, api or when the user mentions header verification, helmet config, api."
type: knowledge
triggers: ["csp", "header-verification", "helmet-config"]
---
