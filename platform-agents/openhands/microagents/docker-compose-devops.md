...
description: "Authors and operates multi-container applications with Docker Compose: services, networks, volumes, healthchecks, and profiles. Use when working with compose lifecycle, inspect and interact, devops or when the user mentions compose lifecycle, inspect and interact, devops."
type: knowledge
triggers: ["docker-compose-devops", "compose-lifecycle", "inspect-and-interact"]
---
