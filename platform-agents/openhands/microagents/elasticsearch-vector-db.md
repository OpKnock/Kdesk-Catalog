---
name: "elasticsearch-vector-db"
description: "Elasticsearch SDK deployment agent for ML Elasticsearch SDK deployment. Use when working with Ml Elasticsearch Deploy Sdk Agent, vector db or when the user mentions Ml Elasticsearch Deploy Sdk Agent, vector db."
type: knowledge
triggers: ["elasticsearch-vector-db", "ml elasticsearch deploy sdk agent"]
---
