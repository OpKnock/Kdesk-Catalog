---
name: "error-budget"
description: "SLO and error budget management: compute error budgets from Prometheus metrics, track burn rates, and trigger alerts when budgets deplete. Use when working with budget calculations, api or when the user mentions budget calculations, api."
type: knowledge
triggers: ["error-budget", "budget-calculations"]
---
