...
description: "Fairness inference server agent. Manages Fairness ML inference server. Use when working with Ml Fairness Inference Server Agent or when the user mentions Ml Fairness Inference Server Agent."
type: knowledge
triggers: ["fairness-agent-2", "ml fairness inference server agent"]
---
