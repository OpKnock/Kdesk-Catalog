---
name: "innovation-model-server"
description: "Innovation server agent. Manages Innovation ML server. Use when working with Ml Innovation Server Agent or when the user mentions Ml Innovation Server Agent."
type: knowledge
triggers: ["innovation-model-server", "ml innovation server agent"]
---
