...
description: "Handle sensitive data in clusters: create generic and TLS secrets from CLI input or files, inject as environment variables or mounted volumes, and decode base64 values for auditing without exposing them in manifests. Use when working with secret create, secret ops, api or when the user mentions secret create, secret ops, api."
type: knowledge
triggers: ["kubernetes-secret", "secret-create", "secret-ops"]
---
