---
name: "lambda-identity-py"
description: "Lambda deployment agent. Manages Lambda ML deployment. Use when working with Ml Lambda Deploy Agent or when the user mentions Ml Lambda Deploy Agent."
type: knowledge
triggers: ["lambda-identity-py", "ml lambda deploy agent"]
---
