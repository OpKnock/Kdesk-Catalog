---
name: "lambda-sdk"
description: "it deployment agent handling ML it deployment. Use when working with Ml Lambda Deploy Sdk Agent or when the user mentions Ml Lambda Deploy Sdk Agent."
type: knowledge
triggers: ["lambda-sdk", "ml lambda deploy sdk agent"]
---
