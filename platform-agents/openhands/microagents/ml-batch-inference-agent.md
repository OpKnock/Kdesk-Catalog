...
description: "Batch inference agent. Manages batch LLM inference. Use when working with Ml Batch Inference Agent or when the user mentions Ml Batch Inference Agent."
type: knowledge
triggers: ["ml-batch-inference-agent", "ml batch inference agent"]
---
