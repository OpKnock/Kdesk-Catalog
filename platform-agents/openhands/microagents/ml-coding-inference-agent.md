---
name: "ml-coding-inference-agent"
description: "Coding inference agent. Manages ML coding inference. Use when working with Ml Coding Inference Agent or when the user mentions Ml Coding Inference Agent."
type: knowledge
triggers: ["ml-coding-inference-agent", "ml coding inference agent"]
---
