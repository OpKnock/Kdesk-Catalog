---
name: "ml-containerized-aws-deploy"
description: "AWS Containerized deployment agent for ML containerized deployment on AWS. Use when working with Ml Containerized Aws Deploy, deployment or when the user mentions Ml Containerized Aws Deploy, deployment."
type: knowledge
triggers: ["ml-containerized-aws-deploy", "ml containerized aws deploy"]
---
