...
description: "Governance inference agent. Manages ML governance inference. Use when working with Ml Governance Inference Agent or when the user mentions Ml Governance Inference Agent."
type: knowledge
triggers: ["ml-governance-inference-agent", "ml governance inference agent"]
---
