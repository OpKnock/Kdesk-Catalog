---
name: "ml-groq-node-agent"
description: "Groq Node.js SDK agent for fast LLM inference. Use when working with Ml Groq Node Agent, inference or when the user mentions Ml Groq Node Agent, inference."
type: knowledge
triggers: ["ml-groq-node-agent", "ml groq node agent"]
---
