...
description: "Observability inference agent. Manages ML observability inference. Use when working with Ml Observability Inference Agent or when the user mentions Ml Observability Inference Agent."
type: knowledge
triggers: ["ml-observability-inference-agent", "ml observability inference agent"]
---
