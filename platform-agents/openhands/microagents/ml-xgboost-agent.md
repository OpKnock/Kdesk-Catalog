...
description: "XGBoost agent for gradient boosting. Use when working with Ml Xgboost Agent, training or when the user mentions Ml Xgboost Agent, training."
type: knowledge
triggers: ["ml-xgboost-agent", "ml xgboost agent"]
---
