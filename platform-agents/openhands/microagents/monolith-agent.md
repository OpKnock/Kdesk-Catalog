---
name: "monolith-agent"
description: "Monolith server agent. Manages monolith ML server. Use when working with Ml Monolith Server Agent or when the user mentions Ml Monolith Server Agent."
type: knowledge
triggers: ["monolith-agent", "ml monolith server agent"]
---
