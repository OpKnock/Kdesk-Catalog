---
name: "optimization-agent-2"
description: "Optimization inference server agent. Manages Optimization ML inference server. Use when working with Ml Optimization Inference Server Agent or when the user mentions Ml Optimization Inference Server Agent."
type: knowledge
triggers: ["optimization-agent-2", "ml optimization inference server agent"]
---
