---
name: "pinecone-sdk"
description: "it deployment agent handling ML it deployment. Use when working with Ml Pinecone Deploy Sdk Agent V2, deployment or when the user mentions Ml Pinecone Deploy Sdk Agent V2, deployment."
type: knowledge
triggers: ["pinecone-sdk", "ml pinecone deploy sdk agent v2"]
---
