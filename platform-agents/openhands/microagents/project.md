---
name: "project"
description: "it SDK deployment agent handling ML it SDK deployment. Use when working with Ml Project Deploy Sdk or when the user mentions Ml Project Deploy Sdk."
type: knowledge
triggers: ["project", "ml project deploy sdk"]
---
