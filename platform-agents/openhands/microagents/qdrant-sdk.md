---
name: "qdrant-sdk"
description: "it deployment agent handling ML it deployment. Use when working with Ml Qdrant Deploy Sdk Agent, vector db or when the user mentions Ml Qdrant Deploy Sdk Agent, vector db."
type: knowledge
triggers: ["qdrant-sdk", "ml qdrant deploy sdk agent"]
---
