---
name: "risk-identity-py"
description: "Risk deployment agent. Manages Risk ML deployment. Use when working with Ml Risk Deploy Agent or when the user mentions Ml Risk Deploy Agent."
type: knowledge
triggers: ["risk-identity-py", "ml risk deploy agent"]
---
