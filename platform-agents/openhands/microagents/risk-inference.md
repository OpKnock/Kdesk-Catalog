---
name: "risk-inference"
description: "Risk inference server agent Manages Risk inference server. Use when working with Ml Risk Inference Server Agent V2 or when the user mentions Ml Risk Inference Server Agent V2."
type: knowledge
triggers: ["risk-inference", "ml risk inference server agent v2"]
---
