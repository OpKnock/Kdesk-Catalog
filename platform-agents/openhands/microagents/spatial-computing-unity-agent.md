---
name: "spatial-computing-unity-agent"
description: "Spatial-Computing Unity specialist agent for unity operations and workflows. Use when working with unity expertise, spatial computing, agent or when the user mentions unity expertise, spatial computing, agent."
type: knowledge
triggers: ["spatial-computing-unity-agent", "unity-expertise"]
---
