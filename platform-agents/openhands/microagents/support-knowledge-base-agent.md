---
name: "support-knowledge-base-agent"
description: "Support Knowledge Base specialist agent for knowledge-base operations and workflows. Use when working with knowledge base expertise, support, knowledge base, agent or when the user mentions knowledge base expertise, support, knowledge base, agent."
type: knowledge
triggers: ["support-knowledge-base-agent", "knowledge-base-expertise"]
---
