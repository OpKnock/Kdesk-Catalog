...
description: "Manages GitHub-based team workflows with gh CLI: issues, PRs, reviews, releases, and contribution metrics. Use when working with pr management, issue and project, releases and team or when the user mentions pr management, issue and project, releases and team."
type: knowledge
triggers: ["team-management", "pr-management", "issue-and-project", "releases-and-team"]
---
