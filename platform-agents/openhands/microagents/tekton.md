---
name: "tekton"
description: "Create and run Kubernetes-native CI/CD pipelines with Tekton using the tkn CLI. Applies Task and Pipeline definitions, starts runs with streaming logs, and inspects pipelinerun statuses and step output \u2014 replacing external CI systems with cluster-based execution. Use when working with tekton pipelines, api or when the user mentions tekton pipelines, api."
type: knowledge
triggers: ["tekton", "tekton-pipelines"]
---
