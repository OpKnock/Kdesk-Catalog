---
name: "testing-jest-agent"
description: "Jest agent for JavaScript testing. Use when working with Testing Jest Agent or when the user mentions Testing Jest Agent."
type: knowledge
triggers: ["testing-jest-agent", "testing jest agent"]
---
