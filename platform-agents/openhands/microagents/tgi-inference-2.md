---
name: "tgi-inference-2"
description: "TGI inference server agent Manages TGI inference server. Use when working with Ml Tgi Inference Server Agent V2 or when the user mentions Ml Tgi Inference Server Agent V2."
type: knowledge
triggers: ["tgi-inference-2", "ml tgi inference server agent v2"]
---
