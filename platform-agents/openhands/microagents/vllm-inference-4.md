---
name: "vllm-inference-4"
description: "vLLM server agent. Manages vLLM ML server. Use when working with Ml Vllm Server Agent, inference or when the user mentions Ml Vllm Server Agent, inference."
type: knowledge
triggers: ["vllm-inference-4", "ml vllm server agent"]
---
