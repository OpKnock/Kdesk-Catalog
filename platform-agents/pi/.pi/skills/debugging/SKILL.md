...
license: "MIT"
compatibility: "Requires dlv, kubectl, ngrep, node, python, tail. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "code-quality"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(dlv:*) Bash(kubectl:*) Bash(ngrep:*) Bash(node:*) Bash(python:*) Bash(tail:*)"
---
