---
name: "properties"
description: "Java properties files: parsing, editing, encoding conversions (native2ascii), and config management in apps. Use when working with properties management, api or when the user mentions properties management, api."
license: "MIT"
compatibility: "Requires grep, java, native2ascii, python3, sed."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Read Grep Bash(java:*) Bash(native2ascii:*) Bash(python3:*) Bash(sed:*)"
---
