...
license: "MIT"
compatibility: "Requires envoy, kubectl. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(envoy:*) Bash(kubectl:*)"
---
...
- Domain context: `kubectl get pods -l app=api -o jsonpath='{.items[0].spec.con`
