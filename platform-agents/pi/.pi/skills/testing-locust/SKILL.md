---
name: "testing-locust"
description: "Locust agent for load testing with Python. Use when working with Testing Locust, automation or when the user mentions Testing Locust, automation."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "testing"}
allowed-tools: "Glob Grep Read Bash(Distributed::*) Bash(Headless::*) Bash(Run::*) Bash(Worker::*)"
---
