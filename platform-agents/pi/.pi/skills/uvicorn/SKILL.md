---
name: "uvicorn"
description: "Serves ASGI applications with uvicorn: dev reload, production workers, HTTP/2, lifecycle, and container deployment. Use when working with uvicorn serving, uvicorn health, backend or when the user mentions uvicorn serving, uvicorn health, backend."
license: "MIT"
compatibility: "Requires lsof, uvicorn. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(lsof:*) Bash(ss:*) Bash(uvicorn:*)"
---
