---
name: "code-quality-markdownlint-agent"
description: "Lints Markdown files for consistent style. Fixes violations, uses project config, ignores vendor paths. Use when working with lint markdown, code quality, agent or when the user mentions lint markdown, code quality, agent."
license: "MIT"
compatibility: "Requires markdownlint (install via `npm install -g markdownlint-cli`), nodejs, markdownlint."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "code-quality"}
allowed-tools: "Glob Grep Read Bash(markdownlint:*)"
---
