---
name: "saml"
description: "Expert SAML 2.0 reference covering signing and verifying assertions with xmlsec1, base64-decoding SAMLResponses, exchanging metadata, and wiring SP-initiated login. Use when working with saml assertion tooling, api or when the user mentions saml assertion tooling, api."
license: "MIT"
compatibility: "Requires openssl, python, xmlsec1. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(openssl:*) Bash(python:*) Bash(xmlsec1:*)"
---
