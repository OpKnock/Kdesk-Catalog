...
allowed-tools: "Glob Grep Read Bash(node:*) Bash(npx:*) Bash(python:*)"
---
...
- Domain context: `npx @stoplight/spectral-cli lint -r .spectral.yaml --format `, `npx @stoplight/spectral-cli lint -r .spectral.yaml --format `
