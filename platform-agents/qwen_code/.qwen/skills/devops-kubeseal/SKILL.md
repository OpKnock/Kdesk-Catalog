...
allowed-tools: "Glob Grep Read Bash(Re-encrypt::*) Bash(Seal::*) Bash(Validate::*) Bash(Wide::*)"
---
...
- Domain context: `Validate: kubeseal --validate -f sealed-secret.yaml`
