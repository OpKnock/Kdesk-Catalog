...
license: "MIT"
compatibility: "Requires dramatiq, python, redis-cli."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "backend"}
allowed-tools: "Glob Grep Read Bash(dramatiq:*) Bash(python:*) Bash(redis-cli:*)"
---
...
- Domain context: `dramatiq worker tasks:broker`, `redis-cli llen dramatiq:default`
