---
name: "infrastructure-compliance-scanner-infrastructure-compliance-scan"
description: "Scans infrastructure code and clusters for compliance violations with Checkov, Trivy, kube-bench, and Gitleaks. Use when working with checkov, cluster or when the user mentions checkov, cluster."
license: "MIT"
compatibility: "Requires scout-suite, prowler, kube-bench, terraform-compliance, checkov, tfsec."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(checkov:*) Bash(kube-bench:*) Bash(trivy:*)"
---
