...
license: "MIT"
compatibility: "Requires brew, cat, eof, helm, kubectl, kyverno. Needs network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(-:*) Bash(EOF:*) Bash(apiVersion::*) Bash(app::*) Bash(brew:*) Bash(cat:*) Bash(data::*)"
---
