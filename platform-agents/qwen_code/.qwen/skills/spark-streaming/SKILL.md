...
license: "MIT"
compatibility: "Requires kafka-console-producer, spark-shell, spark-submit."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(kafka-console-producer:*) Bash(spark-shell:*) Bash(spark-submit:*)"
---
