...
license: "MIT"
compatibility: "Requires pact, openapi, node.js, python, postman, stoplight-studio. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "testing"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(git:*) Bash(node:*) Bash(npm:*) Bash(openapi-diff:*)"
---
