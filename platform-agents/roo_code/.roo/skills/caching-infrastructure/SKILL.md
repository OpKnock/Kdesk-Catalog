...
description: "Operates Redis and Varnish caches: cache-aside patterns, invalidation, hit-rate analysis, and ban/purge workflows. Use when working with redis, varnish, infrastructure or when the user mentions redis, varnish, infrastructure."
license: "MIT"
compatibility: "Requires redis-cli, varnishadm, varnishstat. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(redis-cli:*) Bash(varnishadm:*) Bash(varnishstat:*)"
---
