...
license: "MIT"
compatibility: "Requires node.js, deno, wrangler, netlify, vercel. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(balena:*) Bash(curl:*) Bash(k3d:*) Bash(k3s:*) Bash(keadm:*) Bash(kubeedge:*)"
---
