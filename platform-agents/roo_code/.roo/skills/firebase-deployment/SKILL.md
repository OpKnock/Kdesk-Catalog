...
description: "Firebase SDK deployment agent for ML Firebase SDK deployment. Use when working with Ml Firebase Deploy Sdk, deployment or when the user mentions Ml Firebase Deploy Sdk, deployment."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(docker:*) Bash(firebase:*) Bash(helm:*) Bash(kubectl:*)"
---
