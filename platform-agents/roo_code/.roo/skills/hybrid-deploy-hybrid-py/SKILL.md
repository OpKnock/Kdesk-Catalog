...
description: "Hybrid deployment agent. Manages hybrid cloud-edge ML deployment. Use when working with Ml Hybrid Deploy Agent or when the user mentions Ml Hybrid Deploy Agent."
license: "MIT"
...
- Domain context: `python deploy_hybrid.py --cloud-model gpt-4 --edge-model mod`
