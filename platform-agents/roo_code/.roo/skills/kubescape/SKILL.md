---
name: "kubescape"
description: "Scans Kubernetes clusters, manifests, and images against NSA/CISA, MITRE, and other hardening frameworks with kubescape. Use when working with framework scans, workload and image scan, reporting, security or when the user mentions framework scans, workload and image scan, reporting, security."
license: "MIT"
compatibility: "Requires kubescape."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(kubescape:*)"
---
