...
license: "MIT"
compatibility: "Requires ldapadd, ldapdelete, ldapmodify, ldappasswd, ldapsearch."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(ldapadd:*) Bash(ldapdelete:*) Bash(ldapmodify:*) Bash(ldappasswd:*) Bash(ldapsearch:*)"
---
...
- Domain context: `ldapsearch -x -H ldap://localhost:389 -D 'cn=admin,dc=myapp,`, `ldapadd -x -H ldap://localhost:389 -D 'cn=admin,dc=myapp,dc=`
