...
license: "MIT"
compatibility: "Requires journalctl, logger, logrotate, rsyslogd, tail."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(journalctl:*) Bash(logger:*) Bash(logrotate:*) Bash(rsyslogd:*) Bash(tail:*)"
---
