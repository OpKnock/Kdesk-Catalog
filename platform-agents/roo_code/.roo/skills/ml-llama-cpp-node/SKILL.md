---
name: "ml-llama-cpp-node"
description: "llama-cpp Node.js SDK agent for Node.js bindings to llama.cpp. Use when working with Ml Llama Cpp Node, inference or when the user mentions Ml Llama Cpp Node, inference."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Chat::*) Bash(Client::*) Bash(Context::*) Bash(Generate::*) Bash(Install::*)"
---
