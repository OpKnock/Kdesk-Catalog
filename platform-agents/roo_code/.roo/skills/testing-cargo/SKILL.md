---
name: "testing-cargo"
description: "Cargo test agent for Rust testing framework. Use when working with Testing Cargo, automation or when the user mentions Testing Cargo, automation."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "testing"}
allowed-tools: "Glob Grep Read Bash(Doc::*) Bash(Run::*) Bash(Specific::*) Bash(Verbose::*)"
---
