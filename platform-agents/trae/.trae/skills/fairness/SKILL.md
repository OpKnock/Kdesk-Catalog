---
name: "fairness"
description: "it SDK deployment agent handling ML it SDK deployment. Use when working with Ml Fairness Deploy Sdk or when the user mentions Ml Fairness Deploy Sdk."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(docker:*) Bash(fairness:*) Bash(helm:*) Bash(kubectl:*)"
---
