...
description: "Governance SDK deployment agent for ML Governance SDK deployment. Use when working with Ml Governance Deploy Sdk Agent or when the user mentions Ml Governance Deploy Sdk Agent."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(docker:*) Bash(governance:*) Bash(helm:*) Bash(kubectl:*)"
---
