...
license: "MIT"
compatibility: "Requires ansible-lint, ansible-playbook, checkov, terraform, terrascan, tfsec."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(ansible-lint:*) Bash(ansible-playbook:*) Bash(checkov:*) Bash(terraform:*) Bash(terrascan:*) Bash(tfsec:*) Bash(tofu:*)"
---
