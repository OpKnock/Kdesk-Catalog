...
description: "Agent for building iOS applications with Swift, SwiftUI, and UIKit integration. Use when working with ios development, swift, swiftui or when the user mentions ios development, swift, swiftui."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "mobile"}
allowed-tools: "Glob Grep Read Bash(pod:*) Bash(spm:*) Bash(swift:*) Bash(xcode-select:*) Bash(xcodebuild:*)"
---
