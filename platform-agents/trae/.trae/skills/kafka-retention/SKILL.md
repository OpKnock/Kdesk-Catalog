---
name: "kafka-retention"
description: "Control Kafka data retention: time/size-based retention configs, segment sizing, record deletion by offset, and log dir verification. Use when working with retention config, record deletion, api or when the user mentions retention config, record deletion, api."
license: "MIT"
compatibility: "Requires kafka-configs.sh, kafka-delete-records.sh, kafka-log-dirs.sh, kafka-run-class.sh."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(kafka-configs.sh:*) Bash(kafka-delete-records.sh:*) Bash(kafka-log-dirs.sh:*) Bash(kafka-run-class.sh:*)"
---
