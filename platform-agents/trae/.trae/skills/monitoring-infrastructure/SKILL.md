...
description: "Baseline host monitoring on Linux: CPU, memory, disk, and network telemetry with top, vmstat, iostat, and sar. Use when working with host metrics, history, infrastructure or when the user mentions host metrics, history, infrastructure."
license: "MIT"
compatibility: "Requires free, iostat, sar, top, uptime, vmstat."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "infrastructure"}
allowed-tools: "Glob Grep Read Bash(free:*) Bash(iostat:*) Bash(sar:*) Bash(top:*) Bash(uptime:*) Bash(vmstat:*)"
---
