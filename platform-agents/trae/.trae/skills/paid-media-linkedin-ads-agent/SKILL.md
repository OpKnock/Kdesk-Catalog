---
name: "paid-media-linkedin-ads-agent"
description: "Paid-Media Linkedin Ads specialist agent for linkedin-ads operations and workflows. Use when working with linkedin ads expertise, paid media, linkedin ads, agent or when the user mentions linkedin ads expertise, paid media, linkedin ads, agent."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "paid-media"}
allowed-tools: "Glob Grep Read Bash(linkedin-ads-api:*) Bash(linkedin-ads-cli:*)"
---
