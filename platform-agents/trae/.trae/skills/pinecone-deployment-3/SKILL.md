...
description: "Pinecone server agent. Manages Pinecone ML server. Use when working with Ml Pinecone Server Agent, deployment or when the user mentions Ml Pinecone Server Agent, deployment."
license: "MIT"
...
- Domain context: `python -m pinecone.server --port 8000 --workers 4`
