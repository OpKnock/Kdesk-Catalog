...
license: "MIT"
compatibility: "Requires node.js, python, openssl, jwt-cli, keycloak, auth0. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "security"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(jwt:*) Bash(kcadm.sh:*) Bash(node:*) Bash(npm:*)"
---
