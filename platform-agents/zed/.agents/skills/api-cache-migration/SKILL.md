...
allowed-tools: "Glob Grep Read Bash(aws:*) Bash(curl:*) Bash(redis-cli:*) Bash(varnishadm:*)"
---
...
- Domain context: `redis-cli --scan --pattern 'legacy:*' > keys.txt`, `aws cloudfront create-invalidation --distribution-id E12345 `
