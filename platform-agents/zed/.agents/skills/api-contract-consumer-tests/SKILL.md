...
allowed-tools: "Glob Grep Read Bash(cat:*) Bash(npm:*) Bash(npx:*)"
---
...
- Domain context: `npm install @pact-foundation/pact --save-dev`, `npm install @pact-foundation/pact-js --save-dev`
