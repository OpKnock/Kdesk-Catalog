...
license: "MIT"
compatibility: "Requires kafka-topics, mosquitto_pub, npx, openssl. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(echo:*) Bash(kafka-topics:*) Bash(mosquitto_pub:*) Bash(npx:*) Bash(openssl:*)"
---
