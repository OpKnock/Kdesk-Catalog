...
description: "Terraform agent for infrastructure as code. Use when working with Devops Terraform, deployment or when the user mentions Devops Terraform, deployment."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(Apply::*) Bash(Destroy::*) Bash(Init::*) Bash(Plan::*)"
---
