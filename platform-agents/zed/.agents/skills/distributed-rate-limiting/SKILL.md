...
description: "Designs and operates distributed rate limits across API gateways and services using Redis sliding-window counters, with load-test verification. Use when working with redis window limits, api or when the user mentions redis window limits, api."
license: "MIT"
compatibility: "Requires redis-cli. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(ab:*) Bash(curl:*) Bash(redis-cli:*)"
---
