---
name: "elastic-logs"
description: "Ship, index, and query application logs into Elasticsearch with Filebeat, and run Elasticsearch log queries from the CLI. Use when working with log shipping, api or when the user mentions log shipping, api."
license: "MIT"
compatibility: "Requires filebeat. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(filebeat:*)"
---
