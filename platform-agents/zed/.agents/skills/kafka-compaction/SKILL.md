...
license: "MIT"
compatibility: "Requires kafka-configs.sh, kafka-console-consumer.sh, kafka-log-dirs.sh, kafka-run-class.sh, kafka-topics.sh."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(kafka-configs.sh:*) Bash(kafka-console-consumer.sh:*) Bash(kafka-log-dirs.sh:*) Bash(kafka-run-class.sh:*) Bash(kafka-topics.sh:*)"
---
