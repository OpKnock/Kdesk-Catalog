...
license: "MIT"
compatibility: "Requires docker, filebeat, helm, kubectl, logcli. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "devops"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(docker:*) Bash(filebeat:*) Bash(helm:*) Bash(kubectl:*) Bash(logcli:*)"
---
