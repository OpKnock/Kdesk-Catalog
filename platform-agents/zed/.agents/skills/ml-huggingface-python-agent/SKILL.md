---
name: "ml-huggingface-python-agent"
...
allowed-tools: "Glob Grep Read Bash(Download::*) Bash(Inference::*) Bash(Spaces::*) Bash(Upload::*)"
---
...
- Domain context: `Download: python -c 'from huggingface_hub import hf_hub_down`
