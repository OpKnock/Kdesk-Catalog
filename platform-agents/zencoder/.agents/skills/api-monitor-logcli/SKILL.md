...
description: "Monitors API logs with Loki and LogCLI: label-based querying, logQL pipelines, error-rate derivation, and alerting on log patterns. Use when working with logcli, logql pipelines or when the user mentions logcli, logql pipelines."
license: "MIT"
...
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(logcli:*)"
---
