---
name: "cost-cloudhealth"
description: "CloudHealth agent for multi-cloud cost management. Use when working with Cost Cloudhealth, optimization or when the user mentions Cost Cloudhealth, optimization."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "finops"}
allowed-tools: "Glob Grep Read Bash(API::*) Bash(Costs::*) Bash(Perspectives::*) Bash(Recommendations::*)"
---
