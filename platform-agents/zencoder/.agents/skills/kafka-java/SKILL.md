...
license: "MIT"
compatibility: "Requires java, kafka-console-consumer.sh, kafka-console-producer.sh, kafka-consumer-groups.sh, kafka-topics.sh, mvn."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(java:*) Bash(kafka-console-consumer.sh:*) Bash(kafka-console-producer.sh:*) Bash(kafka-consumer-groups.sh:*) Bash(kafka-topics.sh:*) Bash(mvn:*)"
---
