---
name: "loki"
description: "Run and query Grafana Loki: single-binary server, LogQL queries with logcli, promtail shipping, and label-based filtering. Use when working with loki server, logcli query, api or when the user mentions loki server, logcli query, api."
license: "MIT"
compatibility: "Requires docker, logcli. Needs network access."
metadata: {"author": "Kdesk", "version": "2.0.0", "category": "api"}
allowed-tools: "Glob Grep Read Bash(curl:*) Bash(docker:*) Bash(logcli:*)"
---
