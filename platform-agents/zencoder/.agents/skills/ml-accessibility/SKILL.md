...
description: "it agent handling inclusive AI/ML applications. Use when working with Ml Accessibility, inference or when the user mentions Ml Accessibility, inference."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Alt:*) Bash(Screen:*) Bash(Testing::*) Bash(Voice::*)"
---
