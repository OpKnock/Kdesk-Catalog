---
name: "ml-anthropic-python-agent"
description: "Anthropic Python SDK agent for Claude model usage. Use when working with Ml Anthropic Python Agent, inference or when the user mentions Ml Anthropic Python Agent, inference."
license: "MIT"
compatibility: "No special requirements."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Chat::*) Bash(Stream::*)"
---
...
- Domain context: `Chat: python -c 'import anthropic; client = anthropic.Anthro`
