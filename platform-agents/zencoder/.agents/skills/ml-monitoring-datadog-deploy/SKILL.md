...
description: "Datadog Monitoring deployment agent for ML monitoring with Datadog. Use when working with Ml Monitoring Datadog Deploy or when the user mentions Ml Monitoring Datadog Deploy."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Agent::*) Bash(Dashboard::*) Bash(Metrics::*)"
---
