...
description: "Weaviate deployment agent for vector database deployment. Use when working with Ml Weaviate Deploy, vector db or when the user mentions Ml Weaviate Deploy, vector db."
license: "MIT"
compatibility: "Requires network access."
metadata: {"author": "Kdesk", "version": "1.0.0", "category": "ml"}
allowed-tools: "Glob Grep Read Bash(Object::*) Bash(Query::*) Bash(Schema::*) Bash(Status::*)"
---
